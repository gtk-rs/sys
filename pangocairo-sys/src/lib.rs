...
extern "C" {
    ...
    pub fn pango_cairo_font_map_new_for_font_type(fonttype: cairo::CairoFontType) -> *mut pango::PangoFontMap;
    pub fn pango_cairo_font_map_create_context(fontmap: *mut PangoCairoFontMap) -> *mut pango::PangoContext;
    pub fn pango_cairo_font_map_get_font_type(fontmap: *mut PangoCairoFontMap) -> cairo::CairoFontType;
